...
#define MUSIC_METADATA_ADDR_OFFSET  (4 + (8 * MUSIC_SONG_OWNER_STR_SIZE) + 4)
...
#define	MUSIC_LOOP_MIDICH_MINVALUE			0
#define	MUSIC_LOOP_MIDICH_MAXVALUE			15
#define	MUSIC_LOOP_MIDICH_DEFAULTVALUE		0
