...
#ifndef ARRANGEMENT_PARAMETERS_MNG_H_
#define ARRANGEMENT_PARAMETERS_MNG_H_
...
#define ARRANGEMENT_MSG_SIZE	(3*ARRANGEMENT_MSG_MAXSIZE)
...
#define ARRANGEMENT_EVENT_SIZE	((2*ARRANGEMENT_MSG_SIZE) + (ARRANGEMENT_MAXEVENTACTION*ARRANGEMENT_EVENTACTION_SIZE) + ARRANGEMENT_EXITCONDITION_SIZE)
...
#endif // ARRANGEMENT_PARAMETERS_MNG_H_
